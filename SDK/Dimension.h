...
public:
	...
	virtual void onAreaChanged(C_BlockSource &, Vec3i const &, Vec3i const &);
	virtual void onBlockChanged(C_BlockSource &, Vec3i const &, unsigned int, C_Block const &, C_Block const &, int, class ActorBlockSyncMessage const *, class BlockChangedEventTarget);
	virtual void onBrightnessChanged(C_BlockSource &, Vec3i const &);
	...
	virtual void addParticleEffect2(HashedString const &, C_Entity const &, HashedString const &, Vec3 const &, MolangVariableMap const &);
	virtual void addTerrainParticleEffect(Vec3i const &, C_Block const &, Vec3 const &, float, float, float);
	virtual void addTerrainSlideEffect(Vec3i const &, C_Block const &, Vec3 const &, float, float, float);
