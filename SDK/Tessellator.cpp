...
mce::Mesh* BlockTessellator::getMeshForBlockInWorld(Tessellator *t, C_Block *block, Vec3i &pos) {
	using BT_getMeshForBlockInWorld_t = mce::Mesh* (*)(BlockTessellator *, Tessellator *, C_Block *, Vec3i &, int, __int64);
