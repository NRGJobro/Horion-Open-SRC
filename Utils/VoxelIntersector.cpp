...
#define EPS 10e-5f
#define SIGN3(A) \
	((((A).x < EPS) ? 4 : 0) | (((A).x > -EPS) ? 32 : 0) | (((A).y < EPS) ? 2 : 0) | (((A).y > -EPS) ? 16 : 0) | (((A).z < EPS) ? 1 : 0) | (((A).z > -EPS) ? 8 : 0))
#endif
...
void Voxel::getBoundingBox(AABB& aabbOut, const Triangle3& t) {
	aabbOut.upper = {MAX3(t.v1.x, t.v2.x, t.v3.x),
					 MAX3(t.v1.y, t.v2.y, t.v3.y),
					 MAX3(t.v1.z, t.v2.z, t.v3.z)};
	aabbOut.lower = {MIN3(t.v1.x, t.v2.x, t.v3.x),
					 MIN3(t.v1.y, t.v2.y, t.v3.y),
...
bool Voxel::intersects(const Vec3& voxel, const Triangle3& triangle) {
	...
	Triangle3 triMutated = {
		...
		{triangle.v3.x - voxel.x - 0.5f, triangle.v3.y - voxel.y - 0.5f, triangle.v3.z - voxel.z - 0.5f}};


	return t_c_intersection(triMutated) == INSIDE;
}
